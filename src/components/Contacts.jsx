...
export const Contacts = () => {
    ...
    return (
        <div name='contacts' className='antialiased bg-black'>
                        ...
                        <div className='bg-black relative rounded-xl z-10 shadow-lg p-8 '>
                            <form action="" ref={form} onSubmit={sendEmail} className='flex flex-col space-y-4'>
                                ...
                                <div>
                                    ...
                                    <textarea type="email" placeholder='Lets have a chat..' rows='4' className='ring-1 ring-[#5221E6] w-full rounded-md px-4 py-2 mt-2 outline-none bg-black focus:ring-2 focus:ring-violet-300' name='message'></textarea>
                                </div>
