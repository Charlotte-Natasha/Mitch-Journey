        ...
        <div className='bg-black h-screen p-4  '>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-8 items-center py-8 text-white'>
                <div>
                    ...
                    <p>UX Designer</p>
                    <p>Designed UI and UX in collaboration with engineering and design teams and manage and implement features.</p>
                </div>
                <div>
                    <h1 className='text-gray-500 lg:text-6xl text-4xl'>02</h1>
                    <p className=''>ROAM AFRICA</p>
                    <p>Product Design, Intern</p>
                    <p>Responsible for projects from research to handoff. Executing designs sprint and including stakeholders and engineers in the design process.</p>
                </div>
                <div>
                    <h1 className='text-gray-500 lg:text-6xl text-4xl'>03</h1>
                    <p className=''>THE AFRICAN TALENT COMPANY,</p>
                    <p>Product Designer</p>
                    <p>Worked with the project manager, QA Engineers and development team to test, build and deploy user interface and user experience using the design process: Planning, Research, Design and Prototyping.</p>
                </div>
            </div>
        </div>
    )
